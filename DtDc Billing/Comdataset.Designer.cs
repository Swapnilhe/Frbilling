...
namespace DtDc_Billing.ComdatasetTableAdapters {
    ...
    public partial class CompanyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Company] ([Company_Id], [Phone], [Email], [Insurance], [Minimum_Risk_Charge], [Other_Details], [Fuel_Sur_Charge], [Topay_Charge], [Cod_Charge], [Gec_Fuel_Sur_Charge], [Pf_code], [Company_Address], [Company_Name], [Datetime_Comp], [Gst_No], [Pan_No], [Royalty_Charges], [D_Docket], [P_Docket], [E_Docket], [V_Docket], [I_Docket], [N_Docket], [Password], [Username], [G_Docket]) VALUES (@Company_Id, @Phone, @Email, @Insurance, @Minimum_Risk_Charge, @Other_Details, @Fuel_Sur_Charge, @Topay_Charge, @Cod_Charge, @Gec_Fuel_Sur_Charge, @Pf_code, @Company_Address, @Company_Name, @Datetime_Comp, @Gst_No, @Pan_No, @Royalty_Charges, @D_Docket, @P_Docket, @E_Docket, @V_Docket, @I_Docket, @N_Docket, @Password, @Username, @G_Docket)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@G_Docket", global::System.Data.SqlDbType.Float, 0, global::System.Data.ParameterDirection.Input, 0, 0, "G_Docket", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Company] SET [Company_Id] = @Company_Id, [Phone] = @Phone, [Email] = @Email, [Insurance] = @Insurance, [Minimum_Risk_Charge] = @Minimum_Risk_Charge, [Other_Details] = @Other_Details, [Fuel_Sur_Charge] = @Fuel_Sur_Charge, [Topay_Charge] = @Topay_Charge, [Cod_Charge] = @Cod_Charge, [Gec_Fuel_Sur_Charge] = @Gec_Fuel_Sur_Charge, [Pf_code] = @Pf_code, [Company_Address] = @Company_Address, [Company_Name] = @Company_Name, [Datetime_Comp] = @Datetime_Comp, [Gst_No] = @Gst_No, [Pan_No] = @Pan_No, [Royalty_Charges] = @Royalty_Charges, [D_Docket] = @D_Docket, [P_Docket] = @P_Docket, [E_Docket] = @E_Docket, [V_Docket] = @V_Docket, [I_Docket] = @I_Docket, [N_Docket] = @N_Docket, [Password] = @Password, [Username] = @Username, [G_Docket] = @G_Docket WHERE (([Company_Id] = @Original_Company_Id))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@G_Docket", global::System.Data.SqlDbType.Float, 0, global::System.Data.ParameterDirection.Input, 0, 0, "G_Docket", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<double> G_Docket, 
                    string Original_Company_Id) {
            return this.Update(Original_Company_Id, Phone, Email, Insurance, Minimum_Risk_Charge, Other_Details, Fuel_Sur_Charge, Topay_Charge, Cod_Charge, Gec_Fuel_Sur_Charge, Pf_code, Company_Address, Company_Name, Datetime_Comp, Gst_No, Pan_No, Royalty_Charges, D_Docket, P_Docket, E_Docket, V_Docket, I_Docket, N_Docket, Password, Username, G_Docket, Original_Company_Id);
        }
    }
