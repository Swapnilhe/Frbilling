...
namespace DtDc_Billing.DataSet3TableAdapters {
    ...
    public partial class NondoxTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Non_ID, Aslab1, Aslab2, Aslab3, Aslab4, Sslab1, Sslab2, Sslab3, Sslab4, AUptosl1, AUptosl2, AUptosl3, AUptosl4, SUptosl1, SUptosl2, SUptosl3, SUptosl4, Sector_Id, Company_id, NoOfSlabN, NoOfSlabS, 
                         CashCounterNon
FROM            Nondox";
        ...
        public virtual int Fill(DataSet3.NondoxDataTable dataTable) {
        ...
        public virtual DataSet3.NondoxDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet3.NondoxDataTable dataTable = new DataSet3.NondoxDataTable();
